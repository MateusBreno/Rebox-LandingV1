  ...
  return (
    <Container id="comoFunciona">
      <Header>
        ...
        <Desc>
          Nossos planos dão direito a assistência veicular 24 horas em todo o Brasil!
        </Desc>
      </Header>
      <Body>
        <BodyWrapper>
          <InfoItem
            ...
            desc2="Temos planos para carros de passeio, motos, SUVs, picapes pequenas com atendimento em todo o Brasil e a maior e mais qualificada rede de prestadores."
          />
          <InfoItem
